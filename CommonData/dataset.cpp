...
Column* DataSet::insertColumn(size_t index, const std::string & name, columnType colType, computedColumnType computedType)
{

	assert(_dataSetID > 0);

	Column * newColumn = Column::addColumn(this, index, name, colType, computedType);
