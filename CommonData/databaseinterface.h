...
public:
	...
	//Columns & Data/Values
	//Index stuff:
	int			columnInsert(			int dataSetId, int index, columnType colType, computedColumnType computedType, bool autoSort);	///< Insert a row into Columns and create the corresponding columns in DataSet_? Also makes sure the indices are correct
