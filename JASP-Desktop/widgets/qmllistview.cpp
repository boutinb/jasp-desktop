...
QMap<QString, QVariant> QMLListView::_readSource(const QVariant& source, QString& sourceName, QString& sourceControl, QString& sourceUse, ValueList& sourceValues)
{
...
QMLListView::ValueList QMLListView::_readValues(const QVariant& values)
{
	ValueList result;
...
void QMLListView::setupSources()
{
	...
	for (const QVariant& source : sources)
	{
		...
		QVector<std::tuple<QString, QString, QString, ValueList, bool> > discards;
...
QMLListView::SourceType::SourceType(
		...
		, const QVector<std::tuple<QString, QString, QString, ValueList, bool> >& _discardModels
	...
	: name(_name), controlName(_controlName), modelUse(_modelUse), values(_values), isValuesSource(_isValuesSource), model(nullptr), conditionExpression(_conditionExpression), combineWithOtherModels(_combineWithOtherModels)
{
	...
	for (const std::tuple<QString, QString, QString, ValueList, bool>& discardModel : _discardModels)
	{
