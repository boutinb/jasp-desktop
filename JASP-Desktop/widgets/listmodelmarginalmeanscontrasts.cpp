...
ListModelMarginalMeansContrasts::ListModelMarginalMeansContrasts(BoundQMLTableView * parent) : ListModelTableViewBase(parent)
{
	_defaultCellVal		= 0;
	_initialRowCnt		= 1;
...
void ListModelMarginalMeansContrasts::loadColumnInfo()
{
	setColName(	_tableView->getItemProperty("colName").toString());
}

void ListModelMarginalMeansContrasts::factorsSourceChanged()
{
	setFactors();
	setColLabels();
}
...
void ListModelMarginalMeansContrasts::setFactorsSource(ListModelRepeatedMeasuresFactors *factorsSourceModel)
{
...
void ListModelMarginalMeansContrasts::setColName(QString colName)
{
	if (_colName == colName)
		return;
...
void ListModelMarginalMeansContrasts::setColLabels()
{
...
void ListModelMarginalMeansContrasts::modelChangedSlot()
{
	if (_boundTo)
	{
...
void ListModelMarginalMeansContrasts::modifyValuesNamesEtcetera()
{
	_rowNames.clear();
...
void ListModelMarginalMeansContrasts::setFactors()
{
	_factors.clear();
...
void ListModelMarginalMeansContrasts::dataSetChangedHandler()
{
	setColLabels();
}
