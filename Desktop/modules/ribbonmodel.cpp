...
void RibbonModel::addSpecialRibbonButtonsEarly()
{
	...
	{
		new AnalysisEntry([&](){ emit this->dataInsertColumnBefore(-1);					},	"insert-column-before",			fq(tr("Insert column before")),	true,		"menu-column-insert-before"),
		new AnalysisEntry([&](){ emit this->dataInsertColumnAfter(-1);					},	"insert-column-after",			fq(tr("Insert column after")),	true,		"menu-column-insert-after"),
		...
		new AnalysisEntry([&](){ emit this->dataInsertComputedColumnBefore(-1,	false);	},	"insert-column-R-before",		fq(tr("Insert column before")),	true,		"menu-column-insert-before"),
		new AnalysisEntry([&](){ emit this->dataInsertComputedColumnAfter( -1,	false);	},	"insert-column-R-after",		fq(tr("Insert column after")),	true,		"menu-column-insert-after"),
		new AnalysisEntry(fq(tr("Computed Columns")), "NotR.png"),
		new AnalysisEntry([&](){ emit this->dataInsertComputedColumnBefore(-1,	true);	},	"insert-column-NotR-before",	fq(tr("Insert column before")),	true,		"menu-column-insert-before"),
		new AnalysisEntry([&](){ emit this->dataInsertComputedColumnAfter( -1,	true);	},	"insert-column-NotR-after",		fq(tr("Insert column after")),	true,		"menu-column-insert-after"),
	});
